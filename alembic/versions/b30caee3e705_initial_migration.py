...
Revision ID: b30caee3e705
Revises: 
Create Date: 2024-04-12 15:29:03.595276
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("first_name", sa.VARCHAR(length=56), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("decription", sa.String(length=512), nullable=False),
